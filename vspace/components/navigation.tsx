  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        {/* Mobile Header */}
        <div className="fixed top-0 left-0 right-0 h-16 bg-white/95 backdrop-blur-md border-b border-gray-200/50 shadow-sm z-50 flex items-center justify-between px-4">
          <Link href="/" className="flex items-center">
            <div className="w-10 h-8 bg-black rounded-lg flex items-center justify-center font-mono text-white text-sm">
              v/s
            </div>
          </Link>
          <Button
